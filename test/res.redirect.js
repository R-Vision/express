...
describe('res', function(){
  ...
  describe('when accepting html', function(){
    it('should respond with html', function(done){
      ...
      .end(function(err, res){
        res.headers.should.have.property('location', 'http://google.com');
        res.text.should.equal('<p>Found. Redirecting to <a href="http://google.com">http://google.com</a></p>');
        done();
      })
    })
    ...
    it('should escape the url', function(done){
      ...
      .set('Accept', 'text/html')
      .end(function(err, res){
        res.text.should.equal('<p>Found. Redirecting to <a href="/&lt;lame&gt;">/&lt;lame&gt;</a></p>');
        done();
      })
    })
  })
  ...
  describe('when accepting text', function(){
    it('should respond with text', function(done){
      ...
      .end(function(err, res){
        res.headers.should.have.property('location', 'http://google.com');
        res.headers.should.have.property('content-length', '39');
        res.text.should.equal('Found. Redirecting to http://google.com');
        done();
      })
    })
    ...
    it('should encode the url', function(done){
      ...
      .set('Accept', 'text/plain, */*')
      .end(function(err, res){
        res.text.should.equal('Found. Redirecting to http://example.com/?param=%3Cscript%3Ealert(%22hax%22);%3C/script%3E');
        done();
      })
    })
  })
